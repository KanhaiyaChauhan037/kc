...
const Statistics = () => {
  ...
  return (
    <div
      style={{ height: "auto" }}
      name="statistics"
      className=" bg-sky-900 w-full h-screen experience mbottom ptop"
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
        ...
        <div style={{marginTop:"60px"}}>
          <img  alt="Abdul Rub's Activity Graph" src="https://activity-graph.herokuapp.com/graph?username=Abdul-rub&bg_color=0D1117&color=5BCDEC&line=5BCDEC&point=FFFFFF&hide_border=true" />
        </div>
